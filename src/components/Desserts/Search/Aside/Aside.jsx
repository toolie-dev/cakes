                ...
                {state => (
                    <div className={classNames(s.wrapper, classGenerator(state))}>
                        <div className={s.elem}>
                            ...
                            <div className={s.wrap}>
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("forGirls") } } className={s.input} id="forGirls" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("forMen") } } className={s.input} id="forMen" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("patriotic") } } className={s.input} id="patriotic" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("nuptial") } } className={s.input} id="nuptial" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("toTheBirthday") } } className={s.input} id="toTheBirthday" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("corporate") } } className={s.input} id="corporate" type="checkbox" />
                        ...
                        <div className={s.elem}>
                            ...
                            <div className={s.wrap}>
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("classicRecipes") } } className={s.input} id="classicRecipes" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("glutenFree") } } className={s.input} id="glutenFree" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("vegan") } } className={s.input} id="vegan" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("withoutSugar") } } className={s.input} id="withoutSugar" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("withFruits") } } className={s.input} id="withFruits" type="checkbox" />
                                ...
                                <div className={s.item}>
                                    <input onChange={ () => { props.setTags("withFlowers") } } className={s.input} id="withFlowers" type="checkbox" />
