...
import ConfectionersPhoto_4 from "../../assets/img/Confectioners/photo_4.png";
import ConfectionersPhoto_5 from "../../assets/img/Confectioners/photo_5.png";
...
export const confectioners = [
    {
        ...
        tags: ["Торти", "Цукерки", "Торти", "Цукерки", "Торти"],
        products: [
            {
                img: CakesPhoto_2,
                cost: "520 грн",
    ...
    },
    {
        ...
        reviews: 59,
        desc: "Кондитер IV разряда и автор «Школа юного кондитера» Рекордсмен книги рекордов...",
        tags: ["Торти", "Капкейки", "Торти", "Цукерки"],
        products: [
            {
                img: CakesPhoto_1,
                cost: "520 грн",
    ...
    },
    {
        ...
        reviews: 15,
        desc: "Кондитер IV разряда и автор «Школа юного кондитера» Рекордсмен книги рекордов...",
        tags: ["Капкейки", "Макаруни", "Цукерки", "Капкейки", "Макаруни", "Цукерки", "Цукерки"],
        products: [
            {
                img: CakesPhoto_5,
                cost: "520 грн",
    ...
    {
        img: ConfectionersPhoto_4,
        name: "Ангеліна Колеснікова",
        reviews: 4,
        desc: "Кондитер IV разряда и автор «Школа юного кондитера» Рекордсмен книги рекордов...",
        tags: ["Торти", "Капкейки", "Цукерки"],
        products: [
            {
                img: CakesPhoto_1,
                cost: "520 грн",
    ...
    {
        img: ConfectionersPhoto_5,
        name: "Кондитерська Blossom: торти, капк...",
        reviews: 18,
        desc: "Кондитер IV разряда и автор «Школа юного кондитера» Рекордсмен книги рекордов...",
        tags: ["Печиво", "Макаруни", "Торти", "Капкейки", "Цукерки"],
        products: [
            {
                img: CakesPhoto_3,
                cost: "520 грн",
